        ...
        <h5>投稿記事の編集</h5>
            <form class="edit_post" enctype="multipart/form-data" action="/posts/update" accept-charset="UTF-8" method="post">
                ...
                <div class="form-item">
                    ...
                    <textarea rows="5" text="text" name="post_title">{{ old('post_title', $post->post_title) }}</textarea>
                </div>
                
                @if ($post->post_comment)
                <div class="form-item">
                    <label for="post_comment">帯コメント</label>
                    <textarea rows="5" text="text" name="post_comment">{{ old('post_comment', $post->post_comment) }}</textarea>
                </div>
                @endif
                
                <div class="form-item">
                    <label for="post_first_greeting">必須<i class="fas fa-check-square ml-1 mr-1"></i>：はじめのあいさつ</label>
                    <textarea rows="5" text="text" name="post_first_greeting">{{ old('post_first_greeting', $post->post_first_greeting) }}</textarea> 
                </div>

                
                <div class="form-item">
                    <label for="post_introduction">必須<i class="fas fa-check-square ml-1 mr-1"></i>：話題の導入</label>
                    <textarea rows="10" text="text" name="post_introduction">{{ old('post_introduction', $post->post_introduction) }}</textarea>
                </div>
                ...
                <div class="form-item">
                    ...
                    <textarea rows="10" text="text" name="post_information">{{ old('post_information', $post->post_information) }}</textarea>
                </div>
                ...
                <div class="form-item">
                    ...
                    <textarea rows="10" text="text" name="post_character">{{ old('post_character', $post->post_character) }}</textarea> 
                </div>
                ...
                <div class="form-item">
                    ...
                    <textarea rows="10" text="text" name="post_story">{{ old('post_story', $post->post_story) }}</textarea>
                </div>
                ...
                <div class="form-item">
                    ...
                    <textarea rows="10" text="text" name="post_spoiler">{{ old('post_spoiler', $post->post_spoiler) }}</textarea> 
                </div>
                ...
                <div class="form-item">
                    ...
                    <textarea rows="15" text="text" name="post_one">{{ old('post_one', $post->post_one) }}</textarea>
                </div>
                
                @if ($post->post_two)
                <div class="form-item">
                    <label for="post_two">感想②</label>
                    <textarea rows="15" text="text" name="post_two">{{ old('post_two', $post->post_two) }}</textarea>
                </div>
                @endif
                ...
                <div class="form-item">
                    ...
                    <textarea rows="15" text="text" name="post_three">{{ old('post_three', $post->post_three) }}</textarea>
                </div>
                @endif        
                ...
                <div class="form-item">
                    ...
                    <textarea rows="10" text="text" name="post_summary">{{ old('post_summary', $post->post_summary) }}</textarea>
                </div>
                <div class="form-item">
                    <label for="post_last_greeting">必須<i class="fas fa-check-square ml-1 mr-1"></i>：最後のあいさつ</label>
                    <textarea rows="5" text="text" name="post_last_greeting">{{ old('post_last_greeting', $post->post_last_greeting) }}</textarea>
                </div>
                <br>
