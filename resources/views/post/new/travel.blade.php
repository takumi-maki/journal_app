...
@include('common.errors')
    <div class="card devise-card">
        <div class="form-group">
            ...
            <p class="text-center">旅行へ出かけて思ったことを書きましょう。</p>
            <form class="new_post" enctype="multipart/form-data" action="{{ action('PostsController@confirm') }}" accept-charset="UTF-8" method="post">
                ...
                <div class="form-item">
                    ...
                    <i class="far fa-hand-point-right"></i><small class="text-secondary">　(ヒント：なぜ旅行に出かけたのですか？　なぜその場所を選んだのですか？　等)</small>
                </div>
                <br>
                <div class="form-item">
                    <label for="post_information">旅行の概要</label>
                    <textarea rows="10" text="text" name="post_information">{{ old('post_information') }}</textarea> 
                    <i class="far fa-hand-point-right"></i><small class="text-secondary">　(ヒント：旅行のスケジュール　その場所の説明　等)</small>
                </div>
                <br>
                <div class="form-item">
                ...
                <br>
                <div class="form-item">
                    <label for="post_story">旅行の出来事</label>
