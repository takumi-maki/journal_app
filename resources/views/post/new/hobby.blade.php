        ...
        <div class="form-group">
            ...
            <form class="new_post" enctype="multipart/form-data" action="{{ action('PostsController@confirm') }}" accept-charset="UTF-8" method="post">
                ...
                <div class="form-item">
                    ...
                    <i class="far fa-hand-point-right"></i><small class="text-secondary">　(ヒント：登場人物が居れば教えてください。)</small>
                </div>
                <br>
                <div class="form-item">
                ...
                <div class="form-item">
                    <label for="post_one">必須<i class="fas fa-check-square ml-1 mr-1"></i>：その趣味をしてて思ったことや気付いたこと①</label>
                ...
                <br>
                <div class="form-item">
                    <label for="post_two">その趣味をしてて思ったことや気付いたこと②</label>
                ...
                <br>
                <div class="form-item">
                    <label for="post_three">その趣味をしてて思ったことや気付いたこと③</label>
