...
@include('common.errors')
    <div class="card devise-card">
        <div class="form-group">
            ...
            <p class="text-center">学習をしてて思ったことを書きましょう。</p>
            <form class="new_post" enctype="multipart/form-data" action="{{ action('PostsController@confirm') }}" accept-charset="UTF-8" method="post">
                ...
                <br>
                <div class="form-item">
                    <label for="post_information">学習した分野の概要</label>
                    <textarea rows="10" text="text" name="post_information">{{ old('post_information') }}</textarea> 
                    <i class="far fa-hand-point-right"></i><small class="text-secondary">　(ヒント：学習した分野について説明があれば教えてくれますか？)</small>
                </div>
                <br>
                
                <div class="form-item">
                    <label for="post_story">学習した内容</label>
                    <textarea rows="10" text="text" name="post_story">{{ old('post_story') }}</textarea>
                    <i class="far fa-hand-point-right"></i><small class="text-secondary">　(ヒント：具体的に何を学習したのか教えてもらえますか？)</small>
                </div>
                <br>
                
                <div class="form-item">
                    <label for="post_one">必須<i class="fas fa-check-square ml-1 mr-1"></i>：学習して思ったことや気付いたこと①</label>
                ...
                <br>
                <div class="form-item">
                    <label for="post_two">学習して思ったことや気付いたこと②</label>
                ...
                <br>
                <div class="form-item">
                    <label for="post_three">学習して思ったことや気付いたこと③</label>
                ...
                <div class="form-item">
                    ...
                    <textarea rows="10" text="text" name="post_summary">{{ old('post_summary') }}</textarea>
